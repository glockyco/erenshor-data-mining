...
internal sealed class ZoneRouterHarness
{
    ...
    private ZoneRouterHarness(
        ...
        GuideDependencyEngine dependencyEngine,
    ...
    public GuideDependencyEngine DependencyEngine { get; }
    ...
    public static (ZoneRouter Router, ZoneRouterHarness Harness) BuildWithZoneLineUnlockedBy(string itemKey)
    {
        ...
        var router = new ZoneRouter(guide, unlocks, dependencyEngine);
        var harness = new ZoneRouterHarness(guide, dependencyEngine, tracker, unlocks, router);
