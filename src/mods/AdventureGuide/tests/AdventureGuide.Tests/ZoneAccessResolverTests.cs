...
public sealed class ZoneAccessResolverTests
{
	...
	public void LockedTravelZone_UsesZoneLineQuestBlocker()
	{
		var builder = new CompiledGuideBuilder()
			...
			.AddZoneLine("zl:ab", scene: "ZoneA", destinationZoneKey: "zone:b",
				x: 10, y: 0, z: 5)
		...
		var resolver = new ZoneAccessResolver(harness.Guide, harness.Tracker, harness.Unlocks, harness.Router);
	...
	public void LockedRoutePrefersFirstBlockedHopOnPath()
	{
		var builder = new CompiledGuideBuilder()
			...
			.AddZoneLine("zl:ab", scene: "ZoneA", destinationZoneKey: "zone:b",
				x: 10, y: 0, z: 5)
			.AddZoneLine("zl:bc", scene: "ZoneB", destinationZoneKey: "zone:c",
				x: 20, y: 0, z: 5)
