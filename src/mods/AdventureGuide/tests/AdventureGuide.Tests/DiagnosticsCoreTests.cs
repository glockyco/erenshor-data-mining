...
public sealed class DiagnosticsCoreTests
{
    ...
    public void EndSpan_PreservesTriggerReasonAndDuration()
    {
        ...
        var token = core.BeginSpan(DiagnosticSpanKind.MarkerRecompute, context, primaryKey: "quest:a");
    ...
    public void RebuildStorm_TriggersIncidentCapture()
    {
        ...
        var core = new DiagnosticsCore(eventCapacity: 64, spanCapacity: 64, incidentThresholds: thresholds);
