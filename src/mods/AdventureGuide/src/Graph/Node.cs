...
public sealed class Node
{
    ...
    [JsonProperty("night_spawn"), DefaultValue(false)]
    public bool NightSpawn { get; set; }

    [JsonProperty("is_enabled"), DefaultValue(true)]
    ...
    [JsonProperty("repeatable"), DefaultValue(false)]
    ...
    [JsonProperty("implicit"), DefaultValue(false)]
    public bool Implicit { get; set; }

    [JsonProperty("kill_turn_in_holder"), DefaultValue(false)]
    public bool KillTurnInHolder { get; set; }

    [JsonProperty("destroy_turn_in_holder"), DefaultValue(false)]
    public bool DestroyTurnInHolder { get; set; }

    [JsonProperty("drop_invuln_on_holder"), DefaultValue(false)]
    public bool DropInvulnOnHolder { get; set; }

    [JsonProperty("once_per_spawn_instance"), DefaultValue(false)]
    public bool OncePerSpawnInstance { get; set; }

    [JsonProperty("item_level")]
    public int? ItemLevel { get; set; }

    [JsonProperty("stackable"), DefaultValue(false)]
    public bool Stackable { get; set; }

    [JsonProperty("is_unique"), DefaultValue(false)]
    public bool IsUnique { get; set; }

    [JsonProperty("template"), DefaultValue(false)]
    public bool Template { get; set; }

    [JsonProperty("is_vendor"), DefaultValue(false)]
    public bool IsVendor { get; set; }

    [JsonProperty("is_friendly"), DefaultValue(false)]
    public bool IsFriendly { get; set; }

    [JsonProperty("invulnerable"), DefaultValue(false)]
    public bool Invulnerable { get; set; }

    [JsonProperty("faction_key")]
    ...
    [JsonProperty("is_rare"), DefaultValue(false)]
    ...
    [JsonProperty("respawns"), DefaultValue(true)]
    public bool Respawns { get; set; } = true;

    [JsonProperty("is_directly_placed"), DefaultValue(false)]
    public bool IsDirectlyPlaced { get; set; }

    [JsonProperty("is_trigger_spawn"), DefaultValue(false)]
    public bool IsTriggerSpawn { get; set; }

    [JsonProperty("key_item_key")]
    public string? KeyItemKey { get; set; }

    [JsonProperty("teleport_item_key")]
    public string? TeleportItemKey { get; set; }

    [JsonProperty("is_dungeon"), DefaultValue(false)]
