...
/// Combined with the compiled guide, this fully determines the frontier, target
/// resolution, and unlock outputs for a quest.
/// </summary>
public sealed class StateSnapshot
{
    ...
    public List<string> Keyring { get; set; } = new();

    [JsonProperty("live_node_states")]
    public Dictionary<string, LiveNodeState> LiveNodeStates { get; set; } = new();
}
