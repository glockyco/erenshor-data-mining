...
public sealed class QuestPlanBuilder
{
    ...
    private void BuildItem(string itemKey)
    {
        ...
        try
        {
            ...
            var sourceGroup = GetOrCreateGroup($"{itemNode.NodeKey}:sources:anyof", PlanGroupKind.ItemSources);
    ...
    private bool IsGroupInfeasible(PlanGroupNode group)
    {
        ...
        bool infeasible = group.GroupKind switch
        {
            ...
            PlanGroupKind.AnyOf or PlanGroupKind.ItemSources => infeasibleCount == totalCount,
            _ => false,
        };
