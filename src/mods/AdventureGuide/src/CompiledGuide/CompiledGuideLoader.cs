...
public static class CompiledGuideLoader
{
    ...
    public static CompiledGuide Load(ManualLogSource log)
    {
        ...
        log.LogInfo(
            $"Loaded compiled guide: {guide.NodeCount} nodes, {guide.EdgeCount} edges, {guide.QuestCount} quests, {guide.ItemCount} items"
        );
        return guide;
    }
    ...
    {
        var data =
            JsonConvert.DeserializeObject<CompiledGuideData>(json)
