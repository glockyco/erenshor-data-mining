...
public sealed class QuestTargetProjector
{
    ...
    )
    {
        ...
        var explanation = target.Semantic.ActionKind switch
        {
            ResolvedActionKind.LootCorpse => NavigationExplanationBuilder.BuildCorpseExplanation(
                target.Semantic,
                goalNode,
                targetNode
            ),
            ResolvedActionKind.LootChest => NavigationExplanationBuilder.BuildLootChestExplanation(
                target.Semantic,
                goalNode,
                targetNode
            ),
            _ => NavigationExplanationBuilder.Build(target.Semantic, goalNode, targetNode),
        };
