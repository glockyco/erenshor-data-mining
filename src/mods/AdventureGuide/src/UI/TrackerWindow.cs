...
public sealed class TrackerWindow
{
    ...
    private readonly Dictionary<string, float> _fadingOut = new(
        System.StringComparer.OrdinalIgnoreCase
    );
    ...
    private readonly Dictionary<string, StepDistance> _distances = new(
        System.StringComparer.OrdinalIgnoreCase
    );
    ...
    private readonly Dictionary<string, int> _cachedStepIndex = new(
        System.StringComparer.OrdinalIgnoreCase
    );
    ...
    private void OnQuestTracked(string dbName)
    {
        ...
        {
            AddedAt = UnityEngine.Time.realtimeSinceStartup,
        };
    ...
    public void Draw()
    {
        ...
        ImGui.SetNextWindowPos(new Vector2(40f, display.Y * 0.5f), cond, new Vector2(0f, 0.5f));
    ...
    /// </summary>
    private (QuestStep? rawStep, QuestStep? displayStep, QuestEntry displayQuest) GetCurrentStep(
        QuestEntry quest
    )
    {
