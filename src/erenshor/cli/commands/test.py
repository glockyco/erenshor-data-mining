...
_NATIVE_TEST_PROJECTS: tuple[_NativeTestProject, ...] = (
    _NativeTestProject(
        ...
        required_ignored_references=(
            Path("src/mods/AdventureGuide/lib/Assembly-CSharp.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.CoreModule.dll"),
            Path("src/mods/AdventureGuide/lib/lunaris/Lunaris.dll"),
            Path("src/mods/AdventureGuide/lib/lunaris/ImGui.NET.dll"),
            Path("src/mods/AdventureGuide/lib/lunaris/System.Numerics.Vectors.dll"),
            Path("src/mods/AdventureGuide/lib/lunaris/Newtonsoft.Json.dll"),
            Path("src/mods/AdventureGuide/lib/lunaris/0Harmony.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.InputLegacyModule.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.IMGUIModule.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.UIModule.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.TextRenderingModule.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.UI.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.AIModule.dll"),
            Path("src/mods/AdventureGuide/lib/UnityEngine.PhysicsModule.dll"),
            Path("src/mods/AdventureGuide/lib/Unity.TextMeshPro.dll"),
        ),
    ),
    _NativeTestProject(
