...
- get_character_loot(character_id) -> for wiki character drop tables
- get_item_drop_sources(item_id) -> for wiki item source sections
- get_guaranteed_drops() -> for wiki guaranteed loot lists
- get_rare_drops() -> for wiki rare drop tables
