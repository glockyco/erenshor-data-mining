...
class SpawnPoint(BaseEntity):
    ...
    spawn_delay_1: float | None = Field(default=None, description="Respawn delay for solo players (seconds)")
    ...
    # Example patrol_points: "(96.97, 85.25, 280.11), (90.84, 85.29, 199.62), (110.99, 85.53, 189.76)"
