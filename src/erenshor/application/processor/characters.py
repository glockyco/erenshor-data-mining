...
def process_characters(
    ...
    def _char_row(d: _CharData) -> dict[str, object]:
        ...
        return {
            ...
            "can_never_see_invis": r.get("CanNeverSeeInvis"),
            "dps_dummy": r.get("DPSDummy"),
            "is_wyrm": r.get("IsWyrm"),
            "no_run": r.get("NoRun"),
            "never_aggro": r.get("NeverAggro"),
            "no_dmg_cap": r.get("NoDmgCap"),
            "can_phantom_strike": r.get("CanPhantomStrike"),
            "no_self_heal": r.get("NoSelfHeal"),
            "aggro_regardless_of_los": r.get("AggroRegardlessofLOS"),
            "ignore_los_for_aggro": r.get("IgnoreLOSForAggro"),
            "sim_players_ignore_until_ordered": r.get("SimPlayersIgnoreUntilOrdered"),
            "enrage": r.get("Enrage"),
            ...
            "emit_vitae_spell_stable_key": r.get("EmitVitaeSpellStableKey"),
            "hot_spell_stable_key": r.get("HotSpellStableKey"),
            "ae_taunt_spell_stable_key": r.get("AeTauntSpellStableKey"),
