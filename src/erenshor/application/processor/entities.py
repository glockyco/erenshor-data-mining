...
def process_quests(
    ...
    """
    # Get quests with their first variant's name. Correlated subquery on
    # MIN(QuestDBIndex) ensures every quest is included regardless of what
    # index its first variant starts at.
    quest_rows = _rows(
        raw,
        """
