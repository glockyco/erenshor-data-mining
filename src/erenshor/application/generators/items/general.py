...
Handles general items (fallback for items that don't fit other categories).
"""
...
__all__ = ["GeneralItemGenerator"]


logger = logging.getLogger(__name__)


class GeneralItemGenerator(ItemGeneratorBase):
    """Generator for general items."""

    def generate_general_block(
        self,
        item: DbItem,
        page_title: str,
        ...
        Returns:
            Rendered block for general item
        """
        ...
        general_ctx = ItemInfoboxContext(
