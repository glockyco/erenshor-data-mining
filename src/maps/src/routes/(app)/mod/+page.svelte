...
<div class="max-w-4xl mx-auto">
	...
	<div class="bg-slate-800 rounded-xl p-8 border border-slate-700 mb-8">
		...
		<div class="mb-8 rounded-lg overflow-hidden border border-slate-600">
			<div class="aspect-video bg-slate-700 flex items-center justify-center">
				<img src="/companion-mod.gif" alt="Companion Mod Demo" class="w-full h-full object-cover"/>
			</div>
		</div>
	...
	<div class="bg-slate-800 rounded-xl p-6 border border-slate-700 mb-8">
		<h4 class="text-xl font-semibold text-white mb-6 text-center flex items-center justify-center">
			<svg class="w-6 h-6 mr-2 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
		...
		<div class="grid md:grid-cols-2 gap-6">
			...
			<div class="bg-slate-700 rounded-lg p-5 border border-slate-600">
				...
				<ul class="text-slate-300 space-y-2 text-sm">
					...
					<li class="flex items-start">
						...
						<span>Start Erenshor and open the map you are in.</span>
					</li>
					<li class="flex items-start">
						<span class="text-purple-400 mr-2">3.</span>
						<span>If you already had the map open before starting the game, you might need to refresh the page.</span>
					</li>
					<li class="flex items-start">
						<span class="text-purple-400 mr-2">4.</span>
						<span>The player marker should automatically appear after opening / refreshing the map page and follow your in-game position when moving.</span>
					</li>
				</ul>
			</div>
			...
			<div class="bg-slate-700 rounded-lg p-5 border border-slate-600">
				...
				<div class="text-slate-300 text-sm space-y-2">
					<p>If the player marker doesn't appear even after refreshing the map page, the mod might not be installed correctly.</p>
					<p>Check your browser's developer console (F12) for errors like the following:</p>
					<div class="bg-slate-800 rounded px-3 py-2 mt-2 font-mono text-xs text-red-300 border border-slate-600">
						WebSocket connection to 'ws://localhost:18584/' failed
					</div>
					<p class="pt-2">To fix this, reinstall the mod following the Steam guide.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="bg-slate-800 rounded-xl p-6 border border-slate-700">
		...
		<p class="text-center text-slate-400 mt-4"><span class="italic">More features maybe eventually coming soon-ish!</span> 😉</p>
	</div>
</div>
