...
<DrawerPortal {...portalProps}>
    ...
    <DrawerPrimitive.Content
        ...
        class={cn(
            'group/drawer-content bg-zinc-800 fixed z-50 flex h-auto flex-col border-zinc-700',
    ...
    >
        <div
            class="bg-zinc-600 mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
        ></div>
        {@render children?.()}
    </DrawerPrimitive.Content>
</DrawerPortal>
