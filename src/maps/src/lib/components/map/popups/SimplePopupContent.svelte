    ...
    <div class="space-y-2">
        ...
        <div class="rounded bg-zinc-800 px-3 py-2">
            <div class="flex items-center justify-between">
                ...
                <WikiLink pageName="Achievements" />
            </div>
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="rounded bg-zinc-800 px-3 py-2">
            ...
            <div class="flex items-center justify-between">
                ...
                <WikiLink pageName={m.keyItemWikiPageName} />
            </div>
        </div>
    </div>
{:else if marker.category === 'item-bag'}
    ...
    <div class="rounded bg-zinc-800 px-3 py-2">
        ...
        <div class="flex items-center justify-between">
            ...
            <WikiLink pageName={m.itemWikiPageName} />
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="rounded bg-zinc-800 px-3 py-2">
            ...
            <div class="flex items-center justify-between">
                ...
                <WikiLink pageName={m.teleportItemWikiPageName} />
            </div>
        </div>
    </div>
