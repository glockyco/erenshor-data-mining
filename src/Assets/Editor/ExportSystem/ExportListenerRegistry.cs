...
public sealed class ExportListenerRegistrationContext
{
    ...
    public void RegisterNullListener(IAssetScanListener<Object> listener) =>
        Scanner.RegisterNullListener(listener);

    public void RegisterGameObjectListener(IAssetScanListener<GameObject> listener) =>
        Scanner.RegisterGameObjectListener(listener);

    public void RegisterComponentListener<T>(IAssetScanListener<T> listener)
        where T : Component => Scanner.RegisterComponentListener(listener);

    public void RegisterScriptableObjectListener<T>(IAssetScanListener<T> listener)
        where T : ScriptableObject => Scanner.RegisterScriptableObjectListener(listener);
}
...
public sealed class ExportListenerDefinition
{
    ...
    )
    {
        if (string.IsNullOrWhiteSpace(key))
            throw new ArgumentException("Listener key must be nonblank.", nameof(key));
        if (string.IsNullOrWhiteSpace(label))
            throw new ArgumentException("Listener label must be nonblank.", nameof(label));
...
{
    internal ExportListenerRegistrationResult(
        int registeredCount,
        DynamicSpawnSourceListener? dynamicSpawnListener
    )
    {
...
public static class ExportListenerRegistry
{
    private static readonly IReadOnlyList<ExportListenerDefinition> _definitions =
        new List<ExportListenerDefinition>
        {
            ...
            new(
                "secretpassages",
                "Secret Passages",
                ExportScanChannel.GameObject,
                Array.Empty<string>(),
                context =>
                    context.RegisterGameObjectListener(new SecretPassageListener(context.Database))
            ),
            new(
                "wishingwells",
                "Wishing Wells",
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterGameObjectListener(new WishingWellListener(context.Database))
            ),
            new(
                "questactivations",
                "Quest Activations",
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterGameObjectListener(
                        new QuestActivationListener(
                            context.Database,
                            context.ZoneLineKeyResolver,
            ...
            new(
                ...
                context =>
                    context.RegisterScriptableObjectListener(
                        new AscensionListener(context.Database)
                    )
            ),
            new(
                "books",
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterScriptableObjectListener(new BookListener(context.Database))
            ),
            new(
                "classes",
                "Classes",
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterScriptableObjectListener(new ClassListener(context.Database))
            ),
            new(
                "quests",
                "Quests",
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterScriptableObjectListener(new QuestListener(context.Database))
            ),
            new(
                "skills",
                "Skills",
                ...
                context =>
                    context.RegisterScriptableObjectListener(
                        new SkillListener(context.Database, context.CharacterKeyResolver)
                    )
            ),
            new(
                "spells",
                ...
                context =>
                    context.RegisterScriptableObjectListener(
                        new SpellListener(context.Database, context.CharacterKeyResolver)
                    )
            ),
            new(
                "stances",
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterScriptableObjectListener(new StanceListener(context.Database))
            ),
            new(
                "guildtopics",
                "Guild Topics",
                ...
                context =>
                    context.RegisterScriptableObjectListener(
                        new GuildTopicListener(context.Database)
                    )
            ),
            new(
                "worldfactions",
                ...
                context =>
                    context.RegisterScriptableObjectListener(
                        new WorldFactionListener(context.Database)
                    )
            ),
            new(
                "zoneatlasentries",
                ...
                context =>
                    context.RegisterScriptableObjectListener(
                        new ZoneAtlasEntryListener(context.Database)
                    )
            ),
            new(
                "items",
                ...
                new[] { "spells" },
                context =>
                    context.RegisterScriptableObjectListener(new ItemListener(context.Database))
            ),
            new(
                "achievementtriggers",
                ...
                context =>
                    context.RegisterComponentListener(
                        new AchievementTriggerListener(context.Database)
                    )
            ),
            new(
                "doors",
            ...
            new(
                ...
                context =>
                    context.RegisterComponentListener(
                        new ClassStartingItemsListener(context.Database)
                    )
            ),
            new(
                "loottables",
                ...
                context =>
                    context.RegisterComponentListener(
                        new LootTableListener(context.Database, context.CharacterKeyResolver)
                    )
            ),
            new(
                "arenarounds",
                ...
                context =>
                    context.RegisterComponentListener(
                        new VithArenaListener(context.Database, context.CharacterKeyResolver)
                    )
            ),
            new(
                "itemdrops",
            ...
            new(
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterComponentListener(new MiningNodeListener(context.Database))
            ),
            new(
                "spawnpoints",
                "Spawn Points",
                ...
                context =>
                {
                    ...
                    context.RegisterComponentListener(
                        new SpawnPointListener(context.Database, context.CharacterKeyResolver)
                    );
                    context.RegisterComponentListener(
                        new SpawnPointTriggerListener(
                            context.Database,
                            context.CharacterKeyResolver
                        )
                    );
                    ...
                    Debug.Log(
                        $"[DynamicSpawn] Catalog path: {catalogPath}, exists: {File.Exists(catalogPath)}"
                    );
                    DynamicSpawnCatalog catalog = DynamicSpawnCatalog.Load(catalogPath);
                    Debug.Log(
                        $"[DynamicSpawn] Catalog loaded: {catalog.Entries.Count} entries, {catalog.KnownScripts.Count} scripts"
                    );
                    context.DynamicSpawnListener = new DynamicSpawnSourceListener(
                        context.Database,
                        context.CharacterKeyResolver,
                        catalog
                    );
            ...
            new(
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterComponentListener(new TreasureHuntingListener(context.Database))
            ),
            new(
                "treasurelocs",
                "Treasure Locations",
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterComponentListener(new TreasureLocListener(context.Database))
            ),
            new(
                "waters",
                "Waters",
            ...
            new(
                ...
                Array.Empty<string>(),
                context =>
                    context.RegisterComponentListener(new ZoneAnnounceListener(context.Database))
            ),
            new(
                "zonelines",
                "Zone Lines",
                ...
                context =>
                    context.RegisterComponentListener(
                        new ZoneLineListener(context.Database, context.ZoneLineKeyResolver)
                    )
            ),
            new(
                "characters",
                ...
                context =>
                    context.RegisterComponentListener(
                        new CharacterListener(context.Database, context.CharacterKeyResolver)
                    )
            ),
        }.AsReadOnly();
    ...
    )
    {
        ...
        foreach (ExportListenerDefinition definition in selected)
        {
            ...
            {
                Debug.LogError(
                    $"[EXPORT_ERROR] Failed to register listener '{definition.Key}': {ex.Message}"
                );
                throw;
            }
        }
    ...
    public static IReadOnlyList<ExportListenerDefinition> Select(IEnumerable<string> requestedKeys)
    {
        ...
        if (unknownKeys.Length > 0)
        {
            throw new ArgumentException(
                $"Unknown listener keys: {string.Join(", ", unknownKeys)}. Available keys: {string.Join(", ", Definitions.Select(definition => definition.Key))}"
            );
        }
            ...
            foreach (string dependency in definition.Dependencies)
            {
                if (!knownKeys.Contains(dependency))
                    throw new InvalidOperationException(
                        $"Listener '{definition.Key}' depends on unknown key '{dependency}'."
                    );
                if (
                    selectedKeys != null
                    && selectedKeys.Contains(definition.Key)
                    && !selectedKeys.Contains(dependency)
                )
                    throw new InvalidOperationException(
                        $"Listener '{definition.Key}' requires selected dependency '{dependency}'."
                    );
                if (!seen.Contains(dependency))
                    throw new InvalidOperationException(
                        $"Listener '{definition.Key}' depends on '{dependency}', which is ordered later."
                    );
            }
        }
    }
