---
title: Adventure Guide Stable-Port Implementation Plan
type: plan
status: implemented
created: 2026-06-18
archived: 2026-06-25
...
6. **Rewrite design docs are historical.** Leave main's `docs/plans/*adventure-guide*` and related plan docs in place (project history). The mod's own `README.md`/`AGENTS.md` are replaced with the stable Lunaris versions.
