...
class TestUnityBatchModeExecuteMethod:
    ...
    def test_execute_method_success(self, mock_popen: MagicMock, tmp_path: Path) -> None:
    ...
    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_execute_method_without_arguments(self, mock_popen: MagicMock, tmp_path: Path) -> None:
    ...
    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_execute_method_creates_log_directory(self, mock_popen: MagicMock, tmp_path: Path) -> None:
    ...
    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_execute_method_project_not_found(self, mock_popen: MagicMock, tmp_path: Path) -> None:
    ...
    def test_execute_method_timeout(self, mock_popen: MagicMock, tmp_path: Path) -> None:
        ...
        # Mock process that never finishes (will timeout)
        mock_process = MagicMock()
...
class TestUnityBatchModeErrorDetection:
    ...
    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_compilation_error_detection(self, mock_popen: MagicMock, tmp_path: Path) -> None:
        ...
        # Mock process
        mock_process = MagicMock()
        mock_process.poll.return_value = 1  # Process has completed
    ...
    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_execution_error_detection(self, mock_popen: MagicMock, tmp_path: Path) -> None:
    ...
    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_runtime_error_detection_export_error(self, mock_popen: MagicMock, tmp_path: Path) -> None:
        ...
        assert "Unity export script failed" in str(exc_info.value)
        assert "Export failed: Database connection failed" in str(exc_info.value)

    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_runtime_error_detection_exception(self, mock_popen: MagicMock, tmp_path: Path) -> None:
    ...
    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_generic_error_when_log_missing(self, mock_popen: MagicMock, tmp_path: Path) -> None:
    ...
    @patch("erenshor.infrastructure.unity.batch_mode.subprocess.Popen")
    def test_success_with_exit_code_zero(self, mock_popen: MagicMock, tmp_path: Path) -> None:
